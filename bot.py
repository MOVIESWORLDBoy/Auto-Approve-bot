...
async def op(_, m :Message):
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            await m.reply_photo("https://graph.org/file/e276ceff64f464d4ef794.jpg", caption="**😉 Hello {}!\nI'm an auto approve Admin Join Requests Bot.\nI can approve users in Groups/Channels. Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @MW_BOTS__**".format(m.from_user.mention), reply_markup=keyboard)
    
        elif m.chat.type == enums.ChatType.GROUP or enums.ChatType.SUPERGROUP:
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ ꜱᴛᴀʀᴛ ᴍᴇ ᴩʀɪᴠᴀᴛᴇ 💁‍♂️", url="https://t.me/MWAUTOACCEPT_BOT?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
...
async def chk(_, cb : CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**😉 Hello {}!\nI'm an auto approve Admin Join Requests Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @MW_BOTS__**".format(cb.from_user.mention), reply_markup=keyboard, disable_web_page_preview=True)
        print(cb.from_user.first_name +" Is started Your Bot!")
    except UserNotParticipant:
        await cb.answer("👨‍💻 You are Not Joined To Our channel. Join Channel and try again. 🙅‍♂️")
